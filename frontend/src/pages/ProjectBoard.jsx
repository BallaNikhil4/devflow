               ...
               <div>
                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                     <button
                        ...
                        className="text-xs bg-indigo-50 text-indigo-700 hover:bg-indigo-100 py-1.5 px-2 rounded-lg font-medium transition-colors border border-indigo-100 cursor-pointer"                        >
                        Generate Tasks
                     </button>
                     <button className="text-xs bg-indigo-50 text-indigo-700 hover:bg-indigo-100 py-1.5 px-2 rounded-lg font-medium transition-colors border border-indigo-100 cursor-pointer"
                        onClick={() =>
                           callAiAction(
                              "http://localhost:8080/ai/suggest-next",
                              "Suggest the next task for my project."
                           )
                        }>
                        Suggest Next Task
                     </button>
                     <button className="text-xs bg-indigo-50 text-indigo-700 hover:bg-indigo-100 py-1.5 px-2 rounded-lg font-medium transition-colors border border-indigo-100 cursor-pointer"
                        onClick={() =>
                           callAiAction(
                              "http://localhost:8080/ai/detect-missing",
                              "Detect important missing tasks."
                           )
                        }>
                        Detect Missing Tasks
                     </button>
                     <button className="text-xs bg-indigo-50 text-indigo-700 hover:bg-indigo-100 py-1.5 px-2 rounded-lg font-medium transition-colors border border-indigo-100 cursor-pointer">Break Down Task</button>
                  </div>
               </div>

               <div className="flex-1 flex flex-col border border-gray-100 rounded-2xl overflow-hidden bg-gray-50 shadow-inner">
                  ...
                  <div className="p-2 bg-white border-t border-gray-100">
                     <div className="relative flex items-center">
                        <textarea
                           ...
                           className="w-full bg-gray-100 border-transparent focus:border-blue-500 focus:bg-white focus:ring-1 focus:ring-blue-500 rounded-xl pl-4 pr-12 py-2.5 text-sm resize-none" rows="1"
